...
with open('ApplicationFormExam.csv', 'r') as file:
	...
	for row in reader:
		...
		SubjectName2=row[15]
		Photo=row[16]
#print(DateTime, CRN,Programme,Branch,AdmissionYear,URN,Semester,NameSelf,NameFather,NameMother,MobileNumber,Email,SubjectCode1,SubjectName1,SubjectCode2,SubjectName2,Photo)
